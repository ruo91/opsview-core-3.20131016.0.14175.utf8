package Opsview::Schema::Servicechecktimedoverridehostexceptions;
...
__PACKAGE__->table(
    __PACKAGE__->opsviewdb . ".servicechecktimedoverridehostexceptions"
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tBMxMqQkektSzjkoJgdgfA
#
# AUTHORS:
