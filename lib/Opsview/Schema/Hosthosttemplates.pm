package Opsview::Schema::Hosthosttemplates;
...
__PACKAGE__->table( __PACKAGE__->opsviewdb . ".hosthosttemplates" );
...
__PACKAGE__->set_primary_key( "hostid", "hosttemplateid" );
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:cY6W/xD8wd2cVnjAfuePLA
#
# AUTHORS:
