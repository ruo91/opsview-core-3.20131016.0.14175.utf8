package Opsview::Schema::Servicecheckhosttemplateexceptions;
...
__PACKAGE__->table(
    __PACKAGE__->opsviewdb . ".servicecheckhosttemplateexceptions"
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:icCC8TyO7Qr1unoetNLBgQ
#
# AUTHORS:
