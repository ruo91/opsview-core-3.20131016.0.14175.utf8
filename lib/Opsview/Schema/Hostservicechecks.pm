package Opsview::Schema::Hostservicechecks;
...
__PACKAGE__->table( __PACKAGE__->opsviewdb . ".hostservicechecks" );
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:x6unlH7DnfLqHgIWgNpdpQ
#
# AUTHORS:
