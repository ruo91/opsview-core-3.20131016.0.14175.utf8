package Opsview::Schema::ContactVariables;
...
__PACKAGE__->table( __PACKAGE__->opsviewdb . ".contact_variables" );
...
__PACKAGE__->set_primary_key( "contactid", "name" );
__PACKAGE__->belongs_to( "contactid", "Opsview::Schema::Contacts",
    { id => "contactid" },
);
