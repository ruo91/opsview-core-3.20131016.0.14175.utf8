package Opsview::Schema::Keywordhosttemplates;
...
__PACKAGE__->table( __PACKAGE__->opsviewdb . ".keywordhosttemplates" );
...
__PACKAGE__->set_primary_key( "keywordid", "hosttemplateid" );
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:pld4c0yrHNuoO9X/FIdlfw
#
# AUTHORS:
