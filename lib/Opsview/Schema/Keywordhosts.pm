package Opsview::Schema::Keywordhosts;
...
__PACKAGE__->table( __PACKAGE__->opsviewdb . ".keywordhosts" );
...
__PACKAGE__->set_primary_key( "keywordid", "hostid" );
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:gEs4tBIqIOQ1Q1uJvYHQag
#
# AUTHORS:
