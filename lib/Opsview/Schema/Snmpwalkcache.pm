package Opsview::Schema::Snmpwalkcache;
...
__PACKAGE__->table( __PACKAGE__->opsviewdb . ".snmpwalkcache" );
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Vo/HC+g1OjZzbDJXSzPCHQ
#
# AUTHORS:
