package Opsview::Schema::Reloadmessages;
...
__PACKAGE__->table( __PACKAGE__->opsviewdb . ".reloadmessages" );
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:evVJh+nt/TGtZNUq80D2Aw
#
# AUTHORS:
