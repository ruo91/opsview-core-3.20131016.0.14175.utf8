package Opsview::Schema::Servicechecksnmpignores;
...
__PACKAGE__->table( __PACKAGE__->opsviewdb . ".servicechecksnmpignores" );
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:87btxoYO+v5w9OFBCVHsgg
#
# AUTHORS:
