package Opsview::Schema::Checktypes;
...
__PACKAGE__->table( __PACKAGE__->opsviewdb . ".checktypes" );
...
__PACKAGE__->has_many(
    ...
    { "foreign.checktype" => "self.id" },
);

# Created by DBIx::Class::Schema::Loader v0.04005 @ 2008-09-17 13:24:37
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2ccxHkQy2zDprJWFDlwpHg
#
# AUTHORS:
