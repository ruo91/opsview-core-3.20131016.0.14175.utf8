package Opsview::Schema::SharednotificationprofileKeywords;
...
__PACKAGE__->table(
    __PACKAGE__->opsviewdb . ".sharednotificationprofile_keywords"
);
...
__PACKAGE__->set_primary_key( "sharednotificationprofileid", "keywordid" );
