package Opsview::Schema::Servicechecktimedoverridehosttemplateexceptions;
...
__PACKAGE__->table(
    __PACKAGE__->opsviewdb . ".servicechecktimedoverridehosttemplateexceptions"
);
...
__PACKAGE__->add_unique_constraint( "servicecheck",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:JgOe37+21IXSFpWfACg56A
#
# AUTHORS:
