...
Autoreq: 0
Autoreqprov: 0
Requires: opsview-base = 4.5.0, opsview-compatibility-check = 3.20131016.0.14175
Requires: opsview-perl >= 4.5.0
...
#BuildArch: noarch
Provides: opsview
Requires: opsview-core >= 3.20131016.0.14175, opsview-web >= 3.20131016.0.14175
Autoreqprov: 0
...
if [ "$1" -ge 2 ] ; then
    ...
    if ! rpm -q opsview-compatibility-check-3.20131016.0.14175 >/dev/null ; then
        echo
        echo
        echo "======================== Compatibility problems found ======================="
        echo
        echo " Please install opsview-compatibility-check-3.20131016.0.14175 first"
        echo
